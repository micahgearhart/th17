...
goi<-list(th17=c("Rorc", "Ccr6", "Maf", "Il17a"),
...
ht_th17 = Heatmap(temp2[,str_detect(colnames(temp2),"^th17")], column_title = "th17", rect_gp = gpar(col = "black", lwd = 0.5),
                  cluster_rows = TRUE, cluster_columns=TRUE,split = goiDF$celltype,
                  row_names_side = "left",col = col_fun, show_heatmap_legend = TRUE)

ht_tfth17 = Heatmap(temp2[,str_detect(colnames(temp2),"^tfhth17")],column_title = "tfhth17", rect_gp = gpar(col = "black", lwd = 0.5),
                    cluster_rows = TRUE, cluster_columns=TRUE,split = goiDF$celltype,
                    show_row_names = FALSE,col = col_fun,show_heatmap_legend = FALSE)
ht_tfh = Heatmap(temp2[,str_detect(colnames(temp2),"^tfh_")], column_title = "tfh", rect_gp = gpar(col = "black", lwd = 0.5),
                 cluster_rows = TRUE, cluster_columns=TRUE,split = goiDF$celltype,
                 show_row_names=F,col = col_fun,show_heatmap_legend = FALSE)

ht_tother = Heatmap(temp2[,str_detect(colnames(temp2),"^tother")], column_title = "tother", rect_gp = gpar(col = "black", lwd = 0.5),
                    cluster_rows = TRUE, cluster_columns=TRUE, split = goiDF$celltype,
